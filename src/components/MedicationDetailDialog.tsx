...
export function MedicationDetailDialog({
  ...
  return (
    <dialog
      ...
      className="fixed inset-0 m-auto z-50 w-[92vw] max-w-2xl h-auto max-h-[85vh] flex flex-col p-0 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/80 text-slate-900 dark:text-slate-100 shadow-2xl backdrop:bg-slate-950/80 backdrop:backdrop-blur-sm overflow-hidden"
    >
      {/* Header */}
